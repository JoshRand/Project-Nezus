...
namespace nezus {
	namespace graphics {
		...
		void BatchRenderer2D::init()
		{
			...
			m_FTFont = ftgl::texture_font_new_from_file(m_FTAtlas, 32, "Source_Sans_Pro_Light.ttf");

			//for (char c = 'A'; c < '?'; c++)
			//{
			//	ftgl::texture_font_get_glyph(m_FTFont, c);
			//}
			//ftgl::texture_font_get_glyph(m_FTFont, '$');
			//ftgl::texture_font_get_glyph(m_FTFont, 'A');
			//ftgl::texture_font_get_glyph(m_FTFont, 'e');
			//ftgl::texture_font_get_glyph(m_FTFont, '!');
